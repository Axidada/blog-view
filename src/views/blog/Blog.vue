  ...
  <div>
            ...
            <el-popover placement="top"
              ...
              <div class="ui orange basic label"
                ...
                <div class="image">
                  ...
                  <img :src="$store.state.siteInfo.reward"
                       alt=""
              ...
              <el-button slot="reference"
                         class="ui orange inverted circular button m-text-500">赞赏</el-button>
            </el-popover>
          </div>
          <!--横线-->
          ...
          <div class="row m-padded-tb-no">
            <div class="column m-padding-left-no">
              <router-link :to="`/tag/${tag.name}`"
                           ...
                           :key="index">{{ tag.name }}</router-link>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="ui attached positive message">
      <ul class="list">
        ...
        <li>本站点采用<a href="https://creativecommons.org/licenses/by/4.0/"
             target="_blank"> 署名 4.0 国际 (CC BY 4.0) </a>创作共享协议。可自由转载、引用，并且允许商业性使用。但需署名作者且注明文章出处。</li>
      </ul>
    </div>
    <!--评论-->
